...
<%--
	@modelObject - int gameId - gameId in current page url
	@modelObject - Map<String, List<GameBasicDataDTO> headToHead - head to head data for regulation and playoff
 --%>
				...
				<div class="h2h-list">
					<c:forEach items="${headToHead.get('Playoff')}" var="game">
						...
						<div class="h2h-team-info">
							...
							<div class="h2h-team-name">${game.awayTeamAbr}</div>
						</div></div>
					</c:forEach>
				</div>
			</c:when>
