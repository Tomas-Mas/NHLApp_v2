...
public class GameController {
	...
	public ModelAndView loadOverview(@PathVariable int gameId) {
		...
		GameBasicDataDTO gameData = gameBasicDataService.getById(gameId);
		...
		model.addObject("headToHead", gameBasicDataService.getHeadToHeadMapByGameAndTeams(gameId, gameData.getHomeTeamId(), gameData.getAwayTeamId()));
